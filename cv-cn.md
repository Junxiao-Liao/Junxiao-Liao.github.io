...
### 工学学士学位 [**@济南：山东大学软件学院**](https://www.sc.sdu.edu.cn/) *2020年9月 - 2024年6月*

**专业：数字媒体技术** – 在核心计算机科学主题（数学、数据结构、计算机体系结构、操作系统、计算机网络、数据库）方面建立了坚实基础，并包括计算机图形学、数字图像处理、机器学习和深度学习的高级研究。
